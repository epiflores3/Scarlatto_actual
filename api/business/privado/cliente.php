    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'create':
                ...
                } elseif (!$cliente->setApellido($_POST['apellidoc'])) {
                        $result['exception'] = 'Apellido del cliente incorrecto';
                ...
                } elseif (!$cliente->setTelefono($_POST['telefonoc'])) {
                    $result['exception'] = 'Teléfono del cliente incorrecto';
                ...
                } elseif (!$cliente->setEstado($_POST['estadoc'])) {
             ...
             case 'update':
                $_POST = Validator::validateForm($_POST);
                 if (!$cliente->setId($_POST['id'])) {
                    ...
                    $result['exception'] = 'Clave del cliente incorrecto';
                } elseif (!$cliente->setEstado(isset($_POST['estadoc']) ? 1 : 0))  {
                    $result['exception'] = 'Estado del cliente incorrecto';
